# com.alanthechatbot.app.AlanTheChatBot project template
...
1. After that, locate the `src/main/java/com.alanthechatbot.app.AlanTheChatBot.java` file, right-click it, and choose
   `Run com.alanthechatbot.app.AlanTheChatBot.main()` (if the code editor is showing compile errors, try restarting the
   IDE). If the setup is correct, you should see something like the below as the output:
   ```
   Hello from
    ____        _        
   |  _ \ _   _| | _____ 
